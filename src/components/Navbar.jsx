            ...
            <nav className="mx-auto max-w-7xl px-6 py-4">
                <div className="flex items-center justify-between rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 px-6 py-3">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600"></div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative group">
                            ...
                            {/* Dropdown */}
                            {profileOpen && (
                                <div className="absolute right-0 mt-2   bg-slate-900 border border-white/10 backdrop-blur-xl rounded-xl shadow-lg w-40 p-2">
